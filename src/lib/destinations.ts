...
export const destinations: DestinationEntry[] = [
  {
    ...
    region: "Himalayas",
    country: "India",
    tagline: "Houseboats and slow water.",
    mood: "A valley that holds its breath each morning.",
    palette: { bg: "#eef0ea", ink: "#2a3326", accent: "#7a8a5f" },
    hero: kashmir,
    cover: kashmir,
    gallery: [kashmir, ladakh, shelf1, bookOpen],
    story: [
    ...
    pairings: ["ladakh", "japan", "rajasthan"],
  ...
  },
  {
    ...
    mood: "Walls of paper. A bell at dusk. The discipline of small gestures.",
    palette: { bg: "#f3eee7", ink: "#1d1c1a", accent: "#7c2d1e" },
    hero: kyoto,
    cover: kyoto,
    gallery: [kyoto, shelf2, bookOpen, bookStack],
    story: [
    ...
    pairings: ["kashmir", "europe", "kerala"],
  ...
  },
  {
    ...
    region: "Konkan coast",
    country: "India",
    tagline: "Salt, palms, slow Sundays.",
    mood: "Faded Portuguese yellow. A rope hammock. The sound of nothing in particular.",
    palette: { bg: "#f6ecdc", ink: "#3a2418", accent: "#c97a3a" },
    hero: goa,
    cover: goa,
    gallery: [goa, bali, kerala, shelf1],
    story: [
    ...
    pairings: ["kerala", "bali", "rajasthan"],
  ...
  },
  {
    slug: "rajasthan",
    name: "Rajasthan",
    region: "Pink City & beyond",
    country: "India",
    tagline: "Light through carved sandstone.",
    mood: "Pigment, dust, mirrored embroidery. Everything photographs itself.",
    palette: { bg: "#f5e1d4", ink: "#3f1b14", accent: "#a73a2c" },
    hero: rajasthan,
    cover: rajasthan,
    gallery: [rajasthan, morocco, shelf2, bookStack],
    story: [
  ...
  },
  {
    slug: "bali",
    name: "Bali",
    region: "Ubud highlands",
    country: "Indonesia",
    tagline: "Terraces wrapped in fog.",
    mood: "Wet green, warm rain, frangipani on stone.",
    palette: { bg: "#e9eee2", ink: "#1f2a1d", accent: "#5d7a4a" },
    hero: bali,
    cover: bali,
    gallery: [bali, kerala, goa, shelf1],
    story: [
  ...
  },
  {
    ...
    region: "Backwaters",
    country: "India",
    tagline: "A morning that lasts all day.",
    mood: "Coconut palm shadow. The slow knock of a wooden hull.",
    palette: { bg: "#eaf0e8", ink: "#1c2a23", accent: "#3f6b4d" },
    hero: kerala,
    cover: kerala,
    gallery: [kerala, bali, goa, bookOpen],
    story: [
  ...
  },
  {
    ...
    country: "India",
    tagline: "Where the road simply stops.",
    mood: "Thin air, thick silence. A monastery painted onto a cliff.",
    palette: { bg: "#ecebe4", ink: "#22241d", accent: "#9c6b2f" },
    hero: ladakh,
    cover: ladakh,
    gallery: [ladakh, kashmir, shelf2, bookStack],
    story: [
    ...
    pairings: ["kashmir", "japan", "rajasthan"],
  ...
  },
  {
    ...
    country: "Iceland",
    tagline: "Fog, fjord, fire.",
    mood: "Weather that arrives in chapters.",
    palette: { bg: "#e8ecee", ink: "#1a1f24", accent: "#3b5a6b" },
    hero: iceland,
    cover: iceland,
    gallery: [iceland, shelf2, bookOpen, bookStack],
    story: [
  ...
  },
  {
    slug: "morocco",
    name: "Morocco",
    region: "Marrakech to Atlas",
    country: "Morocco",
    tagline: "Clay, shadow, ochre.",
    mood: "Tile, leather, mint tea. A medina lit by lanterns.",
    palette: { bg: "#f3e3cd", ink: "#3a1f10", accent: "#b6532a" },
    hero: morocco,
    cover: morocco,
    gallery: [morocco, rajasthan, shelf1, bookStack],
    story: [
