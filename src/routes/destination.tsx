...
const destinations: D[] = [
  ...
  { slug: "europe", name: "Europe", region: "North Atlantic", tagline: "Fog, fjord, fire.", img: iceland, span: "md:col-span-5", ratio: "aspect-[4/5]" },
      ...
      <section className="container-edit pt-24 md:pt-32 pb-16">
        <div className="grid md:grid-cols-12 gap-10 items-end">
          <div className="md:col-span-8">
            <p className="eyebrow">Step Two · The Place</p>
          ...
          <p className="md:col-span-4 text-muted-foreground leading-relaxed">
            ...
            {state.edition ? <span className="block mt-3 eyebrow !text-foreground">For your {state.edition.name}</span> : null}
          </p>
        </div>
      </section>
